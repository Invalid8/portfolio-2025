        ...
        <div className="space-y-8 max-w-3xl">
          ...
          <div className="space-y-6">
            <ContentSpan
              sectionKey="about"
              as="p"
              className="text-lg md:text-xl text-pretty leading-relaxed lg:leading-[1.9] tracking-wide text-neutral-300"
              fieldKey="leading1"
            >
            ...
            <ContentSpan
              ...
              fieldKey="leading2"
            >
              When I&apos;m not coding, I enjoy gaming, playing Mobile Legends,
              and diving into new technologies to stay ahead in my field. Always
              curious and eager to learn, I aim to create impactful solutions
              through technology.
            </ContentSpan>
          </div>
